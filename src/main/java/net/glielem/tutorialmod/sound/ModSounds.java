package net.glielem.tutorialmod.sound;
...
//ogg file type and mono not stereo
public class ModSounds {
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String name){
        return SOUND_EVENTS.register(name,
                () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, name)));
    }
